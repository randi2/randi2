...
public class TestBenutzerRegistrieren {
	...
	public static void setUpBeforeClass() {
		...
		sel = new DefaultSelenium("localhost", 4444,
				"*iexplore C:/Programme/Internet Explorer/iexplore.exe",
				"http://www.iap.hs-heilbronn.de:8080/randinightly/");
		sel.start();
	}
	...
	public void korrektesZentrumspasswort() {
		...
		sel.select("Titel", "label=Dr.");
		sel.type("Vorname", "Willi");
		sel.type("Nachname", "Wichtig");
