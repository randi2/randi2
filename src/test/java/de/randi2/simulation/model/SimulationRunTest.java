...
public class SimulationRunTest {
	...
	public void testMarginalBalance2Arms() {
		SimulationRun simRun = new SimulationRun(new int[] { 10, 20 } ,  null, null);
		...
		simRun = new SimulationRun(new int[] { 20, 20 },  null, null);
		...
		simRun = new SimulationRun(new int[] { 100, 500 },  null, null);
	...
	public void testMarginalBalance3Arms() {
		SimulationRun simRun = new SimulationRun(new int[] { 10, 20, 30 },  null, null);
		simRun.setSubjectsPerArms(new int[] { 8, 20, 32 });
		double roundedResult = Math
				.round((simRun.getMarginalBalace() * 100000.0)) / 100000.0;
		assertEquals(roundedResult,  0.09302);

		simRun = new SimulationRun(new int[] { 20, 20, 20 },  null, null);
		simRun.setSubjectsPerArms(new int[] { 20, 20, 20 });
		roundedResult = Math
				.round((simRun.getMarginalBalace() * 100000.0)) / 100000.0;
		assertEquals(roundedResult, 0.0);
		
		simRun = new SimulationRun(new int[] { 100, 100, 100 },  null, null);
