...
public class MinimizationMapElementWrapperTest extends AbstractDomainDatabaseTest<MinimizationMapElementWrapper> {
	...
	public void persistAndUpdateObject(){
		...
		MinimizationMapElementWrapper mwDB =entityManager.find(MinimizationMapElementWrapper.class, mw.getId());
		...
		mwDB = entityManager.merge(mwDB);
		MinimizationMapElementWrapper mwDB1 =entityManager.find(MinimizationMapElementWrapper.class, mw.getId());
