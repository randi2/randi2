...
public class Step5 {
	...
	public void setSelectedAlgorithmPanelId(String selectedAlgorithmPanelId) {
		...
		.getValue(FacesContext.getCurrentInstance()
				.getELContext());
		if(selectedAlgorithmPanelId.equals(AlgorithmPanelId.BLOCK_RANDOMIZATION.toString())){
			currentTrialHandler.setRandomizationConfig(new BlockRandomizationConfig());
		}
	}
