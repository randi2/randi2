...
public class OpenSessionInViewPhaseListener implements PhaseListener {
	// FIXME As we know, this Listner doesn't function, how he should. We must
	...
	/**
	 * This class is a bit of hack In the OpenSessionInViewFilter, the filtering
	 * is accomplished in one method. This is not an option with this approach.
	 * This class holds all of the local variables that were in the original
	 * doFilter method of OpenSessionInViewFilter.
	 * 
	 * @author Rick
	 * 
	 */
	...
	public void beforePhase(PhaseEvent pe) {
		 ...
		 * HACK ALERT! The before restore_view does not get called for Apache
		 * JSF Portlet bridge when first viewing the JSF Portlet. Thus we will
	...
	/*
	 * Cleanup the Hiberante session. This was taken from the first half of the
	 * doFilter method.
	 */
