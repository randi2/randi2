...
public class Hilfe {
	...
	private static String[][] unterseiten = new String[][] {
					...
					"Hier k&ouml;nnen Sie einen neuen Administrator anlegen. <br> Alle Felder, die mit * makiert sind, sind Pflichtfelder, d.h. diese m&uuml;ssen ausgef&uuml;lt werden!" },
			{
					...
					{ 
						JspTitel.BENUTZER_ANZEIGEN_ADMIN, "Hier werden alle Details des ausgew&auml;lten Benutzer dargestellt. Diese k&ouml;nnen nicht ver&auml;ndert werden!"
					},
					{ 
						JspTitel.BENUTZER_SPERREN, "Um einen Benutzer sperren zu k&ouml;nnen, muss ein Grund hierf&uuml;r angegeben werden!"
					},
					{
						JspTitel.ZENTRUM_AENDERN, "Hier k&ouml;nnen die Daten des ausgew&auml;lten Zentrums ge&auml;ndert werden. <br><br> Die mit '*' gekennzeichneten Felder sind Pflichtfelder, d.h. diese m&uuml;ssen ausgef&uuml;lt sein! "
					}
	};
