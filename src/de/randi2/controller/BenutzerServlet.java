 ...
 * 
 */
public class BenutzerServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
	...
	if (id.equals("CLASS_DISPATCHERSERVLET_LOGIN1"))
	{
		...
		if (gBenutzer.size() == 1)
		{
		    ...
		    {
			request.getSession(true).setAttribute("aBenutzer", gBenutzer.firstElement());
