...
public final class Rolle {
    ...
    private static Recht[] rechteListeStudienleiter = {
            Recht.getRecht(BK_AENDERN), Recht.getRecht(BK_ANSEHEN),
            Recht.getRecht(ZENTREN_ANZEIGEN),
            Recht.getRecht(GRUPPENNACHRICHT_VERSENDEN),
            Recht.getRecht(STUDIE_ANLEGEN), Recht.getRecht(STUDIE_AENDERN),
            Recht.getRecht(STUDIE_PAUSIEREN),
            Recht.getRecht(STUDIENARM_BEENDEN),
            Recht.getRecht(STUDIE_SIMULIEREN),
            Recht.getRecht(STUDIEN_EINSEHEN), Recht.getRecht(STAT_EINSEHEN),
            Recht.getRecht(RANDOMISATION_EXPORTIEREN),
     ...
     */
    private static Recht[] rechteListeAdmin = { Recht.getRecht(BK_AENDERN),
            Recht.getRecht(BK_SPERREN), Recht.getRecht(BK_ANSEHEN),
            Recht.getRecht(ZENTREN_ANZEIGEN), Recht.getRecht(ZENTRUM_AENDERN),
            Recht.getRecht(ZENTRUM_ANLEGEN),
            Recht.getRecht(ZENTRUM_AKTIVIEREN),
            Recht.getRecht(GRUPPENNACHRICHT_VERSENDEN),
            Recht.getRecht(STUDIE_LOESCHEN), Recht.getRecht(ARCHIV_EINSEHEN),
     ...
     *            Rollenname
     * @return Rolle
     * @throws RechtException
     *             {@link RechtException#NULL_ARGUMENT},{@link RechtException#UNGUELITGES_ARGUMENT}
     */
