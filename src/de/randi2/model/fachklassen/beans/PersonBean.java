...
public class PersonBean extends Filter {
    ...
    /*
         ...
         * Geschlecht sind manuell eingetragen, solange die Klasse Konstanten
    ...
    /**
         ...
         *                Titel der Person
         * @param geschlecht
         *                Geschlecht der Person (entspricht der passenden
         *                Konstante aus der de.randi2.utility.Konstanten Klasse)
         * @param email
         *                E-Mailadresse der Person
         * @param telefonnummer
         ...
         *                 Wenn bei der Validierung einer Person Probleme
         *                 auftreten.
         */
    public PersonBean(String nachname, String vorname, Titel titel, char geschlecht, String email, String telefonnummer, String handynummer, String fax) throws PersonException {
	super();
