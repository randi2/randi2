...
Ext.onReady(function(){
	...
	var text = new Ext.form.MiscField({
        fieldLabel: '',
        value: 'Soll die Studie wirklich fortgesetzt werden?',
        width:300
	});    
	...
	bestaetigen.el.createChild({tag: 'input', name: '<%=Parameter.anfrage_id %>', type:'hidden', value: '<%=StudieServlet.anfrage_id.JSP_STUDIE_FORTSETZEN_JA.name() %>'});	
