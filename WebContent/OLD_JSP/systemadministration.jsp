...
<%
			...
			.toString(), JspTitel.SYSTEMADMINISTRATION.toString());
%>
...
<p>Anzahl der im System angemeldeten Personen insgesamt: <%=SessionListener.getCounter()%>

</p>
<!-- Footer --> <%@include file="include/inc_footer.jsp"%>
</div>
