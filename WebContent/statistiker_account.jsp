...
<%
			...
			.toString(), JspTitel.STATISTIKER_ACCOUNT.toString());
%>
...
<form>
<fieldset style="width:60%"><legend><b>Statistiker</b></legend>
<table>
	<tr>
	...
	<tr>
		<td><br>
		<input type="button" name="entsp_ja" value=" Ja " tabindex="1"
			onclick="location.href=''">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
			type="button" name="entsp_nein" value="Nein" tabindex="2"
			onclick="top.location.href='studie_anlegen.jsp'"></td>
	</tr>
</table>
