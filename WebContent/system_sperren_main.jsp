...
<script type="text/javascript" src="js/bestaetigungen.js"></script>
...
<%} else {%>		
	<legend>System sperren</legend>
		...
		<textarea name="lol" cols="50" rows="10" z:required="true" z:message="Bitte den Grund der Sperrung angeben" ><%= msg_gesperrt %></textarea>
