...
<table height="20%">
	<tr>
		...
		<select name="Titel" tabindex="1">
			<option
				<% if(request.getAttribute("Titel")==null){out.print("selected");} %>
				value="kein Titel">kein Titel</option>
			<option
				<% if(request.getAttribute("Titel")!=null&&request.getAttribute("Titel").equals("Dr.")){out.print("selected");} %>
				value="Dr.">Dr.</option>
			<option
				<% if(request.getAttribute("Titel")!=null&&request.getAttribute("Titel").equals("Prof.")){out.print("selected");} %>
				value="Prof.">Prof.</option>
			<option
				<% if(request.getAttribute("Titel")!=null&&request.getAttribute("Titel").equals("Prof. Dr.")){out.print("selected");} %>
				value="Prof. Dr.">Prof. Dr.</option>
		</select><br>
	</tr>
	<tr>
...
<table>
	...
	<tr>
		...
		<input type="text" size="25" maxlength="30" name="Fax"
	...
	<tr>
		...
		<input type="text" size="25" maxlength="30" name="tel_sekretaer"
			value="<%if(request.getAttribute("Telefon")!=null){out.print(request.getAttribute("Telefon"));} %>"
			tabindex="9"></td>
	</tr>
</table>
