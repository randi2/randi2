...
<td> <a class="il_ContainerItemCommand" href="benutzer_anzeigen_admin.jsp">anzeigen</a></td>
<td> <a class="il_ContainerItemCommand" href="benutzer_sperren.jsp">sperren</a></td>
</tr>
<tr class="tblrow1">
	<td> Berger </td>
	<td> Peter </td>
