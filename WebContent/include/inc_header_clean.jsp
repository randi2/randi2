	...
	<table class="breadcrumb_tbl" width="100%" summary="Impressum">
		<tr>
			<td align="right" width="100%"><a href="index.html" id="logout_link"><img src="images/home.gif" width="22" height="22" border="0" title="Zurueck zum Login" alt="Zurueck zum Login"></a></td>
